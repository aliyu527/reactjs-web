...
class ChooseFromPhoto extends Component {
    render () {
        return (
            <div class="modal fade" id="choose-from-my-photo" tabIndex="-1" role="dialog" aria-labelledby="choose-from-my-photo" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered window-popup choose-from-my-photo" role="document">
...
export default ChooseFromPhoto;