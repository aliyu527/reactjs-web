                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="more">
                            ...
                            <svg class="olymp-little-delete js-chat-open"><use href="/static/svg-icons/sprites/icons.svg#olymp-little-delete"></use></svg>
                        </div>
                    </div>
                            ...
                            <div class="form-group label-floating is-empty">
                                ...
                                <div class="add-options-message">
                                    ...
                                    <div class="options-message smile-block">
                                        ...
                                        <svg class="olymp-happy-sticker-icon"><use href="/static/svg-icons/sprites/icons.svg#olymp-happy-sticker-icon"></use></svg>
