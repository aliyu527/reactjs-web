        ...
        return (
            <div class="ui-block">
                <article class="hentry post video">
                    ...
                    <div class="post-video open-status">
                        ...
                        <div class="video-thumb f-none d-none" id={`media-wrapper-${story._id}`} onClick={this.startPlaying.bind(this)}>
                            <video id={story._id} src={Config.FILES.ALBUMS+'/'+album.folder+'/'+album.files[last].filename}></video>
                            <button class={`play-video ${player.playPause == 'pause' ? `d-none` : ``}`}>
