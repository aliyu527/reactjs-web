                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingOne-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne-1">
                                                Breakfast at the Agency<svg class="olymp-dropdown-arrow-icon"><use href="/static/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
                                    ...
                                    <div id="collapseOne-1" class="collapse" role="tabpanel" >
                                        ...
                                        <div class="place inline-items">
                                            <svg class="olymp-add-a-place-icon"><use href="/static/svg-icons/sprites/icons.svg#olymp-add-a-place-icon"></use></svg>
                                    ...
                                    <div class="card-header" role="tab" id="headingTwo-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
                                                Send the new “Olympus” project files to the Agency<svg class="olymp-dropdown-arrow-icon"><use href="/static/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
